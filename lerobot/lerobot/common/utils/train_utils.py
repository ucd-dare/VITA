...
def save_checkpoint(
    ...
    save_training_state(checkpoint_dir, step, optimizer, scheduler, ema)
...
def load_training_state(
    checkpoint_dir: Path, optimizer: Optimizer, scheduler: LRScheduler | None, ema: EMAModel | None
    ...
    if ema is not None:
        ema.load_state_dict(torch.load(training_state_dir / "ema_state.pth"))

    return step, optimizer, scheduler, ema
